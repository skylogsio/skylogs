...
type RunbookActionButtonsProps = {
  onEdit?: () => void;
  onDelete?: () => void;
};

export default function RunbookActionButtons({ onEdit, onDelete }: RunbookActionButtonsProps) {
  ...
  return (
    ...
    >
      {onEdit && (
        <IconButton onClick={onEdit} aria-label="Edit runbook" sx={buttonSx(palette.primary.main)}>
