...
export function EmailConfigCard({
  ...
  return (
    <Card
      sx={{
        borderRadius: 3,
        border: config.isDefault ? `2px solid ${palette.endpoint.email}` : "none",
        boxShadow: `0 8px 14px ${alpha(config.isDefault ? palette.endpoint.email : palette.grey[500], 0.2)}`,
        position: "relative",
        transition: "all 0.2s ease",
        "&:hover": {
          transform: "scale(1.01)",
          boxShadow: `0 12px 18px ${alpha(config.isDefault ? palette.endpoint.email : palette.grey[500], 0.3)}`
        }
      }}
    >
        ...
        >
          <Box
            sx={{
              ...
              height: 64,
              borderRadius: "50%",
              backgroundColor: palette.endpoint.email,
              display: "flex",
              alignItems: "center",
          ...
          <IconButton
            ...
            sx={{
              ...
              "&:hover": {
                backgroundColor: alpha(palette.endpoint.email, 0.2)
              }
            }}
          >
